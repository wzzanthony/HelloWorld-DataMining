...
#This function help us to reduce the used memory
...
sort_result = sorted(dict(zip(continuous_feature_names, model.coef_)).items(), key=lambda x:x[1], reverse=True)
print(sort_result)
...
#5-fold crossValidation to simulate real case situation
...
#Draw Learning Rate Curve and Verification Curve
...
#tuning for models
#three methods: 1.greedy 2.grid search 3.bayes tuning
